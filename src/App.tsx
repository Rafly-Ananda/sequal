      ...
      <main>
        ...
        <section className="px-6 h-screen flex flex-col justify-center">
          <div className="relative w-fit mt-24">
            <h1 className="font-bold text-5xl text-[#f4f4f4] font-Inter lg:text-8xl ">
              We're{' '}
              <span className="underline">
                <span className="bg-gradient-to-r from-cyan-500 to-[#2f55ff] text-transparent bg-clip-text">
                  capital engine
                </span>
              </span>
            ...
            <div className="flex items-center justify-center mt-10 lg:w-fit lg:absolute -top-28 right-0">
              <img
                src={blueBox}
                alt="blue box hero"
        ...
        <section className="bg-[#f4f4f4] flex flex-col items-center justify-center p-12 gap-4">
          ...
          />
          <h1 className="font-bold text-2xl text-[#1f1f1f] text-center lg:text-5xl mt-6">
            Also the
        ...
        {/* Portfolio */}
        <section className="px-6 mt-10" ref={portfolioRef}>
          <div className="flex">
          ...
          <div className="bg-[#f4f4f4] lg:w-fit px-10">
            <p className="font-Jakarta text-sm p-2 lg:text-base">
              <span className="font-bold">//</span> Become the partner of choice
              for communities, business and funding networks who want to
          ...
          <div className="lg:flex items-center justify-center ">
            <div className="grid grid-cols-2 grid-rows-6 border border-[#D9D9D9] mt-10 rounded-xl lg:grid-cols-4 lg:grid-rows-3 lg:w-[80%]">
              <div className="text-white border-r borde-b border-[#d9d9d9] p-6 flex items-center justify-center">
                01
              </div>
              <div className="text-white border-b lg:border-r border-[#d9d9d9] p-6 flex items-center justify-center">
                02
              </div>
              <div className="text-white border-t lg:border-t-0 border-r border-b border-[#d9d9d9] p-6 flex items-center justify-center">
                03
              </div>
              <div className="text-white border-b border-[#d9d9d9] p-6 flex items-center justify-center">
                04
              </div>
              <div className="text-white border-t border-r border-b border-[#d9d9d9] p-6 flex items-center justify-center">
                05
              </div>
              <div className="text-white border-b lg:border-r border-[#d9d9d9] p-6 flex items-center justify-center">
                06
              </div>
              <div className="text-white border-t border-r border-b lg:border-t-0 border-[#d9d9d9] p-6 flex items-center justify-center">
                07
              </div>
              <div className="text-white border-b border-[#d9d9d9] p-6 flex items-center justify-center">
                08
              ...
              <div className="text-white border-b lg:border-b-0 lg:border-r border-[#d9d9d9] p-6 flex items-center justify-center">
                10
              </div>
              <div className="text-white border-t border-r lg:border-t-0 border-[#d9d9d9] p-6 flex items-center justify-center">
                11
              </div>
              <div className="text-white  border-[#d9d9d9] p-6 flex items-center justify-center">
                12
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#2f55ff] mt-10 p-10 relative">
            <img
              src={boxesIllu1}
              alt="illustration 1"
            ...
            <p className="text-[#f4f4f4] font-Jakarta text-right text-xl lg:text-6xl">
            ...
            <p className="text-[#f4f4f4] font-Jakarta text-xs text-right mt-6 lg:text-base">
              Fundamentals to create value for the benefit of the Web3 and
              Blockchain <br className="hidden lg:block" /> world, especially in
              the
        ...
        {/* Mission */}
        <section className="px-6" ref={missionRef}>
          <div className="h-[1px] w-full bg-[#D9D9D9] mt-10 lg:mt-20"></div>
          <div className="lg:flex lg:pt-10 lg:h-[369px]">
            <div className="lg:flex-1">
              ...
              <p className="text-[#f4f4f4] font-Jakarta mt-6">
                ...
                <br className="hidden lg:block" /> funding networks who want to
            ...
            <div className="lg:flex items-center justify-center lg:flex-1">
              ...
              <div className="bg-[#2F55FF] lg:h-full lg:w-full p-6 h-[270px] flex flex-col items-start justify-end gap-4 lg:mt-10">
                ...
                <p className="text-[#f4f4f4] lg:text-lg">
        ...
        {/* Our Focus */}
        <section className="px-6" ref={ourFocusRef}>
          <div className="h-[1px] w-full bg-[#D9D9D9] mt-10 lg:mt-20"></div>
          ...
          <div className="lg:grid lg:grid-cols-3 lg:grid-rows-3 lg:p-10">
            <div className="mt-6">
              <div className="border-t lg:border-r border-[#D9D9D9] py-6 lg:p-10">
            ...
            <div className="mt-6">
              <div className="border-t border-[#D9D9D9] py-6 lg:p-10">
                <div className="w-full flex items-center justify-end">
            ...
            <div className="mt-6 lg:m-0 ">
              <div className="border-t lg:h-full lg:border-r border-[#D9D9D9] py-6 lg:p-10">
                <div className="w-full flex items-center justify-end">
                  <img
                    src={focusCulture}
                    alt="focus culture"
            ...
            <div className="mt-6 lg:m-0 ">
              <div className="border-t lg:h-full lg:border-r border-[#D9D9D9] py-6 lg:p-10">
                <div className="w-full flex items-center justify-end">
                  <img src={focusMedia} alt="focus creative" className="w-10" />
                </div>
            ...
            <div className="mt-6 lg:m-0 ">
              <div className="border-t lg:h-full border-[#D9D9D9] py-6 lg:p-10">
                <div className="w-full flex items-center justify-end">
                  <img
                    src={focusFashion}
                    alt="focus fashion"
            ...
            <div className="mt-6 lg:m-0">
              <div className="border-t lg:border-b lg:border-r  border-[#D9D9D9] py-6 lg:p-10">
                <div className="w-full flex items-center justify-end">
            ...
            <div className="mt-6 lg:m-0">
              <div className="border-t border-b border-[#D9D9D9] py-6 lg:p-10">
                <div className="w-full flex items-center justify-end">
                  <img
                    src={focusBrainstorm}
